...
static Key keys[] = {
	...
	{ 0,                            XF86XK_AudioNext,         spawn,          {.v = backlightupcmd } },
	{ 0,                            XF86XK_AudioPlay,         spawn,          {.v = volumedowncmd } },
	{ 0,                            XF86XK_AudioPrev,         spawn,          {.v = backlightdowncmd } },
	{ 0,                            XF86XK_AudioStop,         spawn,          {.v = volumeupcmd } },
